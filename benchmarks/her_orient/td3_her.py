...
def train(
    ...
    *,
    disable_wandb_finish: bool = False,
) -> list[dict[str, float]]:
    if wandb_log:
    ...
    save_dir = Path(__file__).parents[2] / "saves/her/fetch_pnp"
    ...
    for i in range(n_runs):
        mem_logger = MemLogger(filter="eval/success")
        ...
        if wandb_log and not disable_wandb_finish:
            wandb.finish()
