...
import rotations.modules.td3.std as std
from rotations.modules.td3.goal import (
    actors,
    critics,
...
ALL_STD_ACTORS = {
    ...
    "quadrotor": std.quadrotor_actors,
}

__all__ = ["ALL_GOAL_ACTORS", "ALL_STD_ACTORS", "critics"]
